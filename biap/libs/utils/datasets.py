...
from libs.utils.utils import xyxy2xywh, xywh2xyxy


class UnowLoadImages:
    def __init__(self,image, img_size=416):
        assert image is not None, 'Image is none '
        self.height = img_size
        self.img0 = image
        # Padded resize
        img, *_ = letterbox(self.img0, new_shape=self.height)
    ...
    # def __next__(self):
    #     # Padded resize
    #     img, *_ = letterbox(self.image, new_shape=self.height)
